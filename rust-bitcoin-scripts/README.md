...
Cursor was unable to generate comprehensive tests for spending complex scripts (i.e witness construction).
It handled the base multisig, but not ones for CSV, CLTV, or Taptreee. It gave up - some of the test do not even have any logic.


--- Following was autogenerated ---
